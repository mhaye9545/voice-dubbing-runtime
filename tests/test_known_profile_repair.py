...
from voice_dubbing_runtime.errors import CONSENT_REQUIRED, VoiceRuntimeError
...
class KnownProfileRepairTests(unittest.TestCase):
    ...
    def test_repair_splits_profiles_preserves_history_and_requires_duc_consent(self) -> None:
        ...
        self.assertTrue((self.profiles / "lua_china_base" / "references" / "reference_001.wav").is_file())
